...
import 'package:openapi_story/src/serializers.dart';
import 'package:openapi_story/src/auth/api_key_auth.dart';
import 'package:openapi_story/src/auth/basic_auth.dart';
...
class OpenapiStory {
  ...
  /// by doing that all interceptors will not be executed
  StoriesNearYouApi getStoriesNearYouApi() {
    return StoriesNearYouApi(dio, serializers);
  }
}
