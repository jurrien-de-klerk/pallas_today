...
import 'package:openapi_member/src/api_util.dart';
import 'package:openapi_member/src/model/error.dart';
import 'package:openapi_member/src/model/member.dart';
import 'package:openapi_member/src/model/member_batch.dart';
...
class MembersApi {
  ...
  Future<Response<Member>> getAuthenticatedMember({
  ...
  Future<Response<MemberBatch>> getMembers({
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(MemberBatch),
            ) as MemberBatch;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
