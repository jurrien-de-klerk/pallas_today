...
class ImagesApi {
  ...
  ///
  /// Parameters:
  /// * [storyId] - The ID of the story that owns this image
  /// * [file] - The image file to upload. Supported formats: JPEG, PNG, WebP. Maximum file size: 10 MB.
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [Image] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Image>> addImage({
    ...
    final _path = r'/images/story/{storyId}'.replaceAll(
        '{' r'storyId' '}',
  ...
  Future<Response<Uint8List>> getImage({
    ...
    final _path = r'/images/story/{storyId}/{imageId}'
        .replaceAll(
            '{' r'storyId' '}',
            encodeQueryParameter(_serializers, storyId, const FullType(String))
                .toString())
        .replaceAll(
            '{' r'imageId' '}',
            encodeQueryParameter(_serializers, imageId, const FullType(String))
                .toString());
    final _options = Options(
      method: r'GET',
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> removeImage({
    required String storyId,
    required String imageId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
